                ...
                <div className="footer-container">
                    ...
                    <div className="bottom">
                        ...
                        <div className="copyright" style={{ display: "flex", justifyContent: "space-between" }}>
                            <div className="copy">Copyright &copy; | Cesar Tours. All rights reserved</div>
                            <div className="credits">Project made by Albertdev.dev</div>
                        </div>
                    </div>
                </div>
            </div>
